...
if(isset($_POST['updateUser'])){
    modifikoPerdorues($_POST['perdoruesiid'],$_POST['emri'],$_POST['mbiemri'],$_POST['nrtelefonit'],$_POST['email'],$_POST['fjalekalimi'],$_POST['roli']);
}
if(isset($_GET['pid'])){
...
<div class="formaV">
        ...
        <div class="input_labels">
            ...
            <div class="input_labels">
                ...
                <input type="text" id="nrtelefonit" name="nrtelefonit" value="<?php if(!empty($nrtelefonit)) echo $nrtelefonit ?>">
            </div>
            <div class="input_labels">
            ...
            <div class="input_labels">
                ...
                <?php
                        if(isset($_GET['pid'])){
                            echo "<input id='updateUser' type='submit'
                            name='updateUser' class='addUpdateDeleteBTN' value='Update User'>"; 
                        }
                    ?>
                </div>
            </div>
